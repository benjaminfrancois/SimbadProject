...
public class World {
	...
	private void createFloor(EnvironmentDescription wd) {
		...
		Point3f[] floorCoords = { new Point3f(minx, 0.0f, minz), new Point3f(minx, 0.0f, maxz),
				new Point3f(maxx, 0.0f, maxz), new Point3f(maxx, 0.0f, minz) };
		Vector3f[] floorNormals = { new Vector3f(-0.6f, 0.6f, -0.6f), new Vector3f(-0.6f, 0.6f, 0.6f),
				new Vector3f(0.6f, 0.6f, 0.6f), new Vector3f(0.6f, 0.6f, -0.6f) };
		Vector3f[] floorNormalsSimple = { new Vector3f(0, 1, 0), new Vector3f(0, 1, 0), new Vector3f(0, 1, 0),
				new Vector3f(0, 1, 0) };
	...
	private void createAxis() {
		Point3f[] axisCoords = {
				...
				new Point3f(0.95f, 0.001f, 0.05f), new Point3f(1, 0.001f, 0.0f), new Point3f(0.95f, 0.001f, -0.05f),

				// a small X
				new Point3f(1.0f, 0.001f, 0.1f), new Point3f(0.9f, 0.001f, 0.2f), new Point3f(1.0f, 0.001f, 0.2f),
				new Point3f(0.9f, 0.001f, 0.1f),
				// Z axis arrow
				new Point3f(0.0f, 0.001f, 0.0f), new Point3f(0, 0.001f, 1.0f), new Point3f(0, 0.001f, 1.0f),
				new Point3f(0.05f, 0.001f, 0.95f), new Point3f(0, 0.001f, 1.0f), new Point3f(-0.05f, 0.001f, 0.95f),

				// a small Z
				new Point3f(0.1f, 0.001f, 1.0f), new Point3f(0.2f, 0.001f, 1.0f), new Point3f(0.1f, 0.001f, 0.9f),
				new Point3f(0.2f, 0.001f, 0.9f), new Point3f(0.1f, 0.001f, 1.0f), new Point3f(0.2f, 0.001f, 0.9f),
				// Y axis arrow
				new Point3f(0.0f, 0.001f, 0.0f), new Point3f(0, 1.0f, 0.0f), new Point3f(0, 1.0f, 0.0f),
				new Point3f(0.05f, 0.95f, 0f), new Point3f(0, 1f, 0f), new Point3f(0.00f, 0.95f, 0.05f),

				// a small Y
				new Point3f(0.2f, 1f, 0.0f), new Point3f(0.1f, 0.9f, 0f), new Point3f(0.1f, 1.0f, 0.0f),
	...
	/**
	 * Change the user view Point . Note that we modify the ViewBranch transform not
	 * the scene transform.
	 * 
	...
	public void changeViewPoint(int type, SimpleAgent agent) {
		...
		switch (type) {
		case VIEW_FROM_TOP:
			t1.lookAt(new Point3d(0, worldSize * 1.5, 0), new Point3d(0, 0, 0), new Vector3d(0, 0, -2));
			t1.invert();
